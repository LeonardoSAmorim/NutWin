...
unit RlItensAliEquProteina;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  qrepform, Qrctrls, QuickRpt, jpeg, ExtCtrls, DBTables, Db, CalcAli, NutCnst,
  VisorMedida, VisorCal, RelConfig;

type
  TfmRelItensAliEquProteina = class(TFormReport)
    ...
    taAliGProtNOME: TStringField;
    taAliGProtEQUIVALENCIA: TStringField;
    qbSumario: TQRBand;
    qeMedida: TQRExpr;
    qeQuant: TQRExpr;
    qeNome: TQRExpr;
    quEquivalencia: TQRDBText;
    taAliGProtSINALPROT: TStringField;
    quRefItemsAliNOMESIMP: TStringField;
    taGruProtIDGRUPROT: TStringField;
    taGruProtNOME: TStringField;
    taGruProtPROTEINAS: TFloatField;
    taGruProtCALORIAS: TFloatField;
    taGruProtREADONLY: TStringField;
    taAliGProtREADONLY: TStringField;
    taAliGProtPROTEINAS: TFloatField;
    taAliGProtCALORIAS: TFloatField;
    qrCabecalho: TQRBand;
    ...
    procedure qbSumarioAfterPrint(Sender: TQRCustomBand;
      BandPrinted: Boolean);
    procedure taAliGProtCalcFields(DataSet: TDataSet);
...
var
  fmRelItensAliEquProteina: TfmRelItensAliEquProteina;
...
procedure TfmRelItensAliEquProteina.ReportBeforePrint(
...
procedure TfmRelItensAliEquProteina.Notification(AComponent: TComponent;
...
procedure TfmRelItensAliEquProteina.SetCalculoAlimentar(
...
function TfmRelItensAliEquProteina.GetIDReport: String;
begin
   Result := '{83294A6F-04B5-11D4-9DBF-000021609D7C}';
end;

procedure TfmRelItensAliEquProteina.qbSumarioAfterPrint(
...
procedure TfmRelItensAliEquProteina.taAliGProtCalcFields(
  DataSet: TDataSet);
begin
  inherited;
  dmMotherBoard.DieAlimentoCorrente.DMUmAlimento.GetEquProteinaCalcFields(taAliGProt,quRefItemsAli.FieldByName( 'PESO' ).AsFloat  );
end;

procedure TfmRelItensAliEquProteina.qrCabecalhoBeforePrint(
...
procedure TfmRelItensAliEquProteina.SetRelConfig(const Value: TRelatorio);
begin
   if (Value <> nil) then
   begin
      FRelConfig := Value;
