...
type
  ...
  public
    ...
    function ConnectDictionary(const UserID, UserPassword: WideString): TOleBool; stdcall;
    function ExpandCode(const Code: WideString; var ChildrenNumber: Smallint): TOleBool; stdcall;
    procedure DisconnectDictionary; stdcall;
    function GetFirstCodeByDesc(var Code, Description: WideString): TOleBool; stdcall;
    function GetNextCodeByDesc(var Code, Description: WideString): TOleBool; stdcall;
    function FindCodeByDescription(var Code: WideString; const Description: WideString): Smallint; stdcall;
  ...
  published
    ...
    property DSNPropertyAtiva: TOleBool index 4 read GetPropertyAtiva write SetPropertyAtiva;
  end;
...
begin
   if Assigned(ANode) then
      begin
      if Assigned (ANode.m_Database) then
